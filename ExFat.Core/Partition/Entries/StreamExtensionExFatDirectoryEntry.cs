...
public class StreamExtensionExFatDirectoryEntry : ExFatDirectoryEntry, IDataProvider
{
    ...
    /// The name hash.
    /// </value>
    public IValueProvider<ushort> NameHash { get; }
    /// <summary>
    ...
    /// </value>
    public IValueProvider<ulong> ValidDataLength { get; }
    ...
    public StreamExtensionExFatDirectoryEntry(Memory<byte> buffer) : base(buffer)
    {
        GeneralSecondaryFlags = new EnumValueProvider<ExFatGeneralSecondaryFlags, byte>(new BufferUInt8(buffer.Slice(1)));
        NameLength = new BufferUInt8(buffer.Slice(3));
        NameHash = new BufferUInt16(buffer.Slice(4));
        ValidDataLength = new BufferUInt64(buffer.Slice(8));
