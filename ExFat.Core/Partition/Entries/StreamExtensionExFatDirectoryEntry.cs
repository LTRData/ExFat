...
public class StreamExtensionExFatDirectoryEntry : ExFatDirectoryEntry, IDataProvider
{
    ...
    {
        get => new DataDescriptor(FirstCluster.Value, GeneralSecondaryFlags.Value.HasAny(ExFatGeneralSecondaryFlags.NoFatChain), DataLength.Value, ValidDataLength.Value);
        set
        {
