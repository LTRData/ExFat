...
public class ExFatFilesystemEntry
{
    ...
    {
        get => FileEntry?.CreationDateTimeOffset.Value ?? default;
    ...
    {
        get => FileEntry?.LastWriteDateTimeOffset.Value ?? default;
    ...
    {
        get => FileEntry?.LastAccessDateTimeOffset.Value ?? default;
